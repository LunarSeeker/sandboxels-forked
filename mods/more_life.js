...
elements.infectious_flesh = {//Some stuff taken from scp.js
    ...
    reactions: {
        ...
        "dirty_water": { elem2: "contaminated_liquid" },
        "hard_yolk": { color2: ["#dead43", "#0e824e", "#07755a", "#0c6934"], elem2: "contaminated_liquid" },
        "meat": { color2: ["#9e4839", "#ba6449", "#d2856c", "#a14940"], elem2: "infectious_flesh" },
        "milk": { elem2: "contaminated_liquid" },
        "pilk": { elem1: null },
        "slime": { elem2: "contaminated_liquid" },
        "rotten_meat": { color2: ["#9e4839", "#b8b165", "#b89765", "#a14940"], elem2: "infectious_flesh" },
        "salt_water": { elem2: "contaminated_liquid" },
        "soda": { color2: ["#422016", "#0c6934"], elem2: "contaminated_liquid" },
        "sun": { elem1: "cooked_meat" },
        "water": { elem2: "contaminated_liquid" },
        "yolk": { color2: ["#ffbe33", "#ffcf33", "#0e824e", "#07755a", "#0c6934"], elem2: "contaminated_liquid" },
    },
    tick: function (pixel) {
        if (Math.random() < 0.45) {
            let y = Math.random() < 0.5 ? 0 : -1
